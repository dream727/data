...
int main()
{
	...
	while (true)
	{
		...
		if (key1 == '1')
		{
			cout << "请输入日期格式20xx.xx.xx.xx:xx（输入now获取当前时间）" << endl;
			cin >> dataObj.time;
			cout << "请输入事件" << endl;
			cin >> dataObj.things;
			if (dataObj.time == "now")
		...
		else if (key1 == '2')
		{
			...
			if (key1 == '1')
			{
				cout << "请输入修改行数" << endl;
				cin >> lineNum;
				cout << "请输入修改内容 格式20xx.xx.xx.xx:xx(输入now获取当前时间)" << endl;
				cin >> tempInput1;
				if (tempInput1 == "now")
				{
					getTime(tempInput1);
			...
			else if (key1 == '3')
			{
				cout << "请输入修改行数" << endl;
				cin >> lineNum;
				cout << "请输入修改时间 格式20xx.xx.xx.xx:xx(输入now获取当前时间)" << endl;
				cin >> tempInput1;
				if (tempInput1 == "now")
				{
					getTime(tempInput1);
